export const classifiers: object = {
	LogisticRegression: {
		params: ["C", "solver"], // 'C' for regularization strength, 'solver' for the algorithm
	},
	SupportVectorMachine: {
		params: ["C", "kernel"], // 'C' for regularization strength, 'kernel' for the kernel type
	},
	DecisionTrees: {
